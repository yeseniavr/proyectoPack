            ...
            <div class="form-group">
                <div class="row">
                    <div class="col-md-6 div-nuevo">
					    <label for="numero" class="col-sm-2 control-label">DNI Remitente</label>
					    <input type="text" class="form-control" id="clientes_id" name="clientes_id" required>
					</div>
                    <div class="col-md-6 div-nuevo">
					    <label for="numero" class="col-sm-2 control-label">DNI Destinatario</label>
